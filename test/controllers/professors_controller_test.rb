...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference("Professor.count") do
      post professors_url, params: { professor: { DOB: @professor.DOB, OIB: @professor.OIB, firstName: @professor.firstName, lastName: @professor.lastName } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { DOB: @professor.DOB, OIB: @professor.OIB, firstName: @professor.firstName, lastName: @professor.lastName } }
