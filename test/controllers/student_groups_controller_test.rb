...
class StudentGroupsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create student_group" do
    assert_difference("StudentGroup.count") do
      post student_groups_url, params: { student_group: { classOf: @student_group.classOf, label: @student_group.label, numberOfStudents: @student_group.numberOfStudents } }
    end
  ...
  test "should update student_group" do
    patch student_group_url(@student_group), params: { student_group: { classOf: @student_group.classOf, label: @student_group.label, numberOfStudents: @student_group.numberOfStudents } }
